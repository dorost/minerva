...
Alternative titles:
\begin{items}
\item Dorost Mathematical Framework
...
A mathematical proof can consist several steps to achive the results. An algorithm also can be defined as a mathematical steps; in this way we can claim that by defining this framework we \textbf{might} be able to build a General Problem Solving framework.
